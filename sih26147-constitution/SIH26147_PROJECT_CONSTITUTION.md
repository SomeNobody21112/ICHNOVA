...
| **P2** | Synchronous FSK; receiver delay calibration; DRM characterisation; genome validation on real recordings (synthetic study done, row 31); server-side auth for LAN |
